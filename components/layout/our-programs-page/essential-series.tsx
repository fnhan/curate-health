  ...
  return (
    <section className="bg-white pl-[210px] text-primary" id="essential-series">
      <div className="three-color-border container pl-10 pt-14">
        ...
        <div>
          <h3 className="my-14 text-[32px]">Essential Series</h3>
          <div className="flex">
            <table className="max-h-60 [&_td]:p-6">
              ...
              <tbody className="[&_td]:text-center [&_th]:whitespace-nowrap [&_th]:pr-5">
                ...
                <tr>
                  ...
                  {essentialSeries?.tableContent?.bonusSessions?.map((num) => {
                    return <td key={num}>+ {num}</td>;
                  })}
                </tr>
                <tr className="border-b">
                  <th className="text-left font-normal">Bonus Transferable</th>
                  ...
                  {essentialSeries?.tableContent?.includesSessions?.map(
                    (num, i) => {
                      let bonusSessions = essentialSeries.tableContent
                        ...
                        : 0;
                      return (
                        <td key={num + bonusSessions}>{num + bonusSessions}</td>
                      );
                    }
                  )}
                </tr>
            ...
            <div>
              <ul className="mx-auto flex w-5/12 flex-col gap-8 [&>li]:pl-12">
