  ...
  return (
    <div className="text-primary">
      <section className="bg-white">
        ...
        <div className="container grid grid-cols-[min(95%,_350px)] justify-center gap-8 py-32 md:grid-cols-[repeat(2,_min(100%,_350px))] xl:grid-cols-[repeat(3,_min(100%,_350px))]">
