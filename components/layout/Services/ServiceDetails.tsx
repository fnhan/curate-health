...
<section className='relative text-black bg-white md:h-[560px] 2xl:h-[860px]' id={service.id}>
  <div className='w-full flex flex-col md:flex-row'>
    <div className='mt-12 md:mt-28 mr-10 md:w-1/2  ml-20 flex flex-col'>
      ...
      <br/>
      <div className='text-[12px] mb-10 md:text-[16px] md:leading-[30px] font-normal font-Poppins leading-[20px] tracking-tight'>
  ...
  <div className="w-1/2 pt-20 pb-20 md:-mt-36 2xl:-mt-60 ml-20 text-stone-800 text-[16px] md:text-[18px] 2xl:text-[24px] font-light italic font-['Poppins'] leading-[30px] md:leading-[60px]">
