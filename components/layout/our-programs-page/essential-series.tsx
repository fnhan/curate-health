...
const EssentialSeries = ({
  ...
  return (
    <section
      className="section-grey-border bg-white pt-32 text-primary 2xl:pl-[210px]"
      id="essential-series"
    >
      <div className="essential-green-borders -mt-32 pt-32">
        <div className="essential-series-border container pl-10 pt-14">
