...
<section className='relative text-black bg-white md:h-[560px] 2xl:h-[660px]' id={service.id}>
  ...
  <div className="md:w-1/2 pt-10 pb-20 md:-mt-36 2xl:-mt-60 text-stone-800 text-[16px] md:text-[18px] 2xl:text-[24px] font-light italic font-Poppins leading-[30px] md:leading-[60px]">
    <div className="container md:mt-8">
          {treatments.map((treatment) => (
            <div key={treatment._id} className="flex items-center mb-2">
              ...
              >
                <span className="2xl:container mr-2">{treatment.title}</span>
